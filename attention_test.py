...
for val in list_0_image_desc:
  caption = f"<start> "
  for key, value in val['meta']:
      caption = caption + " " + value + " "

  caption = caption + "<end>"
  name = val['name']
  image_path = file_path_0_images + name
...
def plot_attention(image, result, attention_plot):
    ...
    for l in range(len_result):
        ...
        if len_result%2 == 1 and l == (len_result-2):
...
image_url = "file:\\" + file_path_1_images + 'accidental-quixotic-laughable-base.png'
